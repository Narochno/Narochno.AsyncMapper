...
namespace Narochno.AsyncMapper
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddAsyncMapper(this IServiceCollection services)
        {
            services.AddAsyncMapper(DependencyContext.Default);
        }

        public static void AddAsyncMapper(this IServiceCollection services, DependencyContext dependencyContext)
        {
            services.AddAsyncMapper(GetCandidateAssemblies(dependencyContext));
        }
        ...
        public static void AddAsyncMapper(this IServiceCollection services, IEnumerable<Assembly> assemblies)
        {
            AddRequiredServices(services);

            AddAsyncMapperClasses(services, assemblies);
        }


        private static void AddAsyncMapperClasses(IServiceCollection services, IEnumerable<Assembly> assembliesToScan)
        {
            assembliesToScan = assembliesToScan as Assembly[] ?? assembliesToScan.ToArray();

            var openInterfaces = new[]
            {
                typeof(IAsyncMapping<,>),
                typeof(IAsyncCollectionMapping<,>)
            };
        ...
        {
            services.AddScoped(typeof(IAsyncMapper<>), typeof(AsyncMapper<>));
        }
    }
}